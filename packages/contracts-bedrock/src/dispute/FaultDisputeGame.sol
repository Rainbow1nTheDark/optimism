...
contract FaultDisputeGame is IFaultDisputeGame, Clone, ISemver {
    ...
    function claimCredit(address _recipient) external {
        ...
        // Try to withdraw the WETH amount so it can be used here. Don't bother doing this if the
        // recipient has no credit. We'll still trigger the external call though.
